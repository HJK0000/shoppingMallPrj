...
public class MemberController {
	...
	public String welcome(Model model, Principal principal,
			@AuthenticationPrincipal CustomUserDetails customUserDetails) { // userDetails를 구현한 구현제 -> CustomUserDetails

		System.out.println("member welcome......");
		Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
		CustomUserDetails userDetails = (CustomUserDetails) authentication.getPrincipal(); // 권한이 있는 사용자 정보를 가지고 있는객체에
																							// principal로
