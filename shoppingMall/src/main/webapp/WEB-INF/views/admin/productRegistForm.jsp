...
<body>
	...
	<form action="/admin/regist" name="frm" method="post"
		enctype="multipart/form-data">
		<table board="1">
			<tr>
				<th>상품 카테고리</th>
				<td><select id="sortOptions" name="pcategory"><option
							value="커피">커피</option></select></td>
			</tr>
			<tr>
				<th>상품명</th>
			...
			<tr>
				<th>상품 판매 상태</th>
				<td><select id="sortOptions" name="pstate"><option
							value="판매중">판매중</option>
						<option value="품절">품절</option></select></td>
			</tr>
			<tr>
				<th>배송비</th>
				<td><select id="sortOptions" name="pdelievery"><option
							value="3000원">3000원</option>
